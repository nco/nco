...
# Obtain NCO version 4.0.2-1 tar.gz from Sourceforge using CVS:
# cvs -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco login
# cvs -z3 -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco co -r nco-4_0_2-1 -d nco-%{version} nco
# tar czf nco-%{version}.tar.gz --exclude='nco-4.0.2/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude='ncap_yacc.[ch]' ./nco-%{version}
...
%changelog
* Tue Apr 06 2010 Charlie Zender <zender@uci.edu> - 4.0.2-1
- new upstream 4.0.2
