...
# Obtain NCO version 5.1.9-1 tar.gz from Sourceforge using CVS:
# cvs -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco login
# cvs -z3 -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco co -r nco-5.1.9-1 -d nco-%{version} nco
# tar czf nco-%{version}.tar.gz --exclude='nco-5.1.9/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude='ncap_yacc.[ch]' ./nco-%{version}
...
%changelog
* Fri Dec 15 2023 Charlie Zender <zender@uci.edu> - 5.2.0-1
- new upstream 5.2.0
