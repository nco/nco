...
# Obtain NCO version 4.7.0-alpha01-1 tar.gz from Sourceforge using CVS:
# cvs -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco login
# cvs -z3 -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco co -r nco-4.7.0-alpha01-1 -d nco-%{version} nco
# tar czf nco-%{version}.tar.gz --exclude='nco-4.7.0-alpha01/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude='ncap_yacc.[ch]' ./nco-%{version}
...
%changelog
* Mon Oct 18 2017 Charlie Zender <zender@uci.edu> - 4.7.0-1
- new upstream 4.7.0
