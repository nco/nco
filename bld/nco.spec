...
# Obtain NCO version 4.0.5-1 tar.gz from Sourceforge using CVS:
...
# tar czf nco-%{version}.tar.gz --exclude='nco-4.0.5/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude='ncap_yacc.[ch]' ./nco-%{version}
