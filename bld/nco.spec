...
# cvs -z3 -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco co -r nco-4.4.3-1 -d nco-%{version} nco
...
%changelog
* Thu Apr 02 2014 Charlie Zender <zender@uci.edu> - 4.4.2-1
- new upstream 4.4.3

* Thu Feb 20 2014 Charlie Zender <zender@uci.edu> - 4.4.1-1
- new upstream 4.4.2
