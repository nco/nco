...
# Obtain NCO version 3.9.4-1 tar.gz from Sourceforge using CVS:
...
# tar czf nco-%{version}.tar.gz --exclude='nco-3.9.4/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude='ncap_yacc.[ch]' ./nco-%{version}
