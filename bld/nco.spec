...
# Obtain NCO version 3.9.9-1 tar.gz from Sourceforge using CVS:
# cvs -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco login
# cvs -z3 -d:pserver:anonymous@nco.cvs.sf.net:/cvsroot/nco co -r nco-3_9_9-1 -d nco-%{version} nco
# tar czf nco-%{version}.tar.gz --exclude='nco-3.9.9/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude='ncap_yacc.[ch]' ./nco-%{version}
...
%changelog
* Mon May 05 2009 Charlie Zender <zender@uci.edu> - 3.9.9-1
- new upstream 3.9.9
