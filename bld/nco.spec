...
# tar czf nco-%{version}.tar.gz --exclude='nco-3.9.2/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude='ncap_yacc.[ch]' ./nco-%{version}
...
%changelog
* Fri Jun 29 2007 Charlie Zender <zender@uci.edu> - 3.9.2-1
- new upstream 3.9.2
