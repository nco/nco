...
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln nco-2_9_5 # Build, do not install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --nst_all nco-2_9_5 # Install, do not build
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --nst_all nco-2_9_5 # Build and install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_cnt nco-2_9_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_prs nco-2_9_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cgd_cnt nco-2_9_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cray_prs nco-2_9_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --bbl_cnt nco-2_9_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --blk_cnt nco-2_9_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --dat_cnt nco-2_9_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --ute_prs nco-2_9_5
...
my $CVS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.130 2004-06-03 05:51:54 zender Exp $';
...
my $CVS_Date='$Date: 2004-06-03 05:51:54 $';
my $CVS_Id='$Id: nco_dst.pl,v 1.130 2004-06-03 05:51:54 zender Exp $';
my $CVS_Revision='$Revision: 1.130 $';
