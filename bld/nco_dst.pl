...
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln nco-3_1_9 # Build, do not install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --nst_all nco-3_1_9 # Install, do not build
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --nst_all nco-3_1_9 # Build and install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_cnt nco-3_1_9
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_prs nco-3_1_9
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cgd_cnt nco-3_1_9
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cray_prs nco-3_1_9
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --bbl_cnt nco-3_1_9
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --blk_cnt nco-3_1_9
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --dat_cnt nco-3_1_9
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --ute_prs nco-3_1_9
...
my $CVS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.156 2007-03-11 05:03:36 zender Exp $';
...
my $CVS_Date='$Date: 2007-03-11 05:03:36 $';
my $CVS_Id='$Id: nco_dst.pl,v 1.156 2007-03-11 05:03:36 zender Exp $';
my $CVS_Revision='$Revision: 1.156 $';
...
# Set up FTP server
    chdir $dst_pth_pfx or die "$prg_nm: ERROR unable to chdir to $dst_pth_pfx: $!\n"; # $! is system error string
    cmd_prc("$tar_cmd cvzf $dst_fl --exclude='nco-3.1.9/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude=ncap_yacc.[ch] ./$dst_vrs"); # Create gzipped tarfile
