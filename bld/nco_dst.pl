...
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln nco-4_0_5 # Build, do not install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --nst_all nco-4_0_5 # Install, do not build
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --nst_all nco-4_0_5 # Build and install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_cnt nco-4_0_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_prs nco-4_0_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cgd_cnt nco-4_0_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cray_prs nco-4_0_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --bbl_cnt nco-4_0_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --blk_cnt nco-4_0_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --dat_cnt nco-4_0_5
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --ute_prs nco-4_0_5
...
my $CVS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.181 2010-09-24 18:44:13 zender Exp $';
...
my $CVS_Date='$Date: 2010-09-24 18:44:13 $';
my $CVS_Id='$Id: nco_dst.pl,v 1.181 2010-09-24 18:44:13 zender Exp $';
my $CVS_Revision='$Revision: 1.181 $';
...
# Set up FTP server
    chdir $dst_pth_pfx or die "$prg_nm: ERROR unable to chdir to $dst_pth_pfx: $!\n"; # $! is system error string
    cmd_prc("$tar_cmd cvzf $dst_fl --exclude='nco-4.0.5/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude=ncap_yacc.[ch] ./$dst_vrs"); # Create gzipped tarfile
