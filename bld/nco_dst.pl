...
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln nco-2_7_4 # Build, do not install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --nst_all nco-2_7_4 # Install, do not build
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --nst_all nco-2_7_4 # Build and install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_cnt nco-2_7_4
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_prs nco-2_7_4
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cgd_cnt nco-2_7_4
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cray_prs nco-2_7_4
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --bbl_cnt nco-2_7_4
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --blk_cnt nco-2_7_4
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --dat_cnt nco-2_7_4
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --ute_prs nco-2_7_4 
...
my $CVS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.107 2003-07-04 20:48:27 zender Exp $';
...
my $CVS_Date='$Date: 2003-07-04 20:48:27 $';
my $CVS_Id='$Id: nco_dst.pl,v 1.107 2003-07-04 20:48:27 zender Exp $';
my $CVS_Revision='$Revision: 1.107 $';
...
# Set up FTP server
    ...
    cmd_prc("$rsh_cmd $www_mch $rm_cmd $www_drc/$dst_fl"); # Remove any distribution with same name
    if($dly_snp){cmd_prc("$rsh_cmd $www_mch $rm_cmd -r $www_drc/nco-????????.tar.gz");} # Remove previous daily snapshots from WWW server
    cmd_prc("$rcp_cmd $dst_fl $www_mch:$www_drc"); # Copy local tarfile to WWW server
