...
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln nco-2_8_0 # Build, do not install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --nst_all nco-2_8_0 # Install, do not build
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --nst_all nco-2_8_0 # Build and install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_cnt nco-2_8_0
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_prs nco-2_8_0
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cgd_cnt nco-2_8_0
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cray_prs nco-2_8_0
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --bbl_cnt nco-2_8_0
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --blk_cnt nco-2_8_0
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --dat_cnt nco-2_8_0
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --ute_prs nco-2_8_0 
...
my $CVS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.110 2003-08-13 20:09:54 zender Exp $';
...
my $CVS_Date='$Date: 2003-08-13 20:09:54 $';
my $CVS_Id='$Id: nco_dst.pl,v 1.110 2003-08-13 20:09:54 zender Exp $';
my $CVS_Revision='$Revision: 1.110 $';
...
$dst_fl_chg=$dst.'_'.$nco_vrs.'-1_i386.changes'; # Debian changes
$dst_fl_deb=$dst.'_'.$nco_vrs.'-1_i386.deb'; # Debian executables and libraries
$dst_fl_doc=$dst.'-doc_'.$nco_vrs.'-1_all.deb'; # Debian documentation
$dst_fl_dsc=$dst.'_'.$nco_vrs.'-1.dsc'; # Debian description
$dst_fl_tgz=$dst.'_'.$nco_vrs.'-1.tar.gz'; # Debian tarball
...
# Full release procedure (public releases only) includes update Web pages
	...
	cmd_prc("$rsh_cmd $www_mch \"cd $www_drc; ln -s ./src/$dst_fl nco.tar.gz\"");
...
# Hence it generates warnings when used with -p, and is not properly updated
    if($True){
	cmd_prc("$rcp_cmd_no_prs_prm $dst_pth_pfx/$dst_fl $dst_pth_bld/doc/index.shtml $dst_pth_bld/doc/nco_news.shtml $dst_pth_bld/doc/README $dst_pth_bld/doc/TODO $dst_pth_bld/doc/VERSION $dst_pth_bld/doc/ChangeLog $www_mch_mrr:$www_drc_mrr");
