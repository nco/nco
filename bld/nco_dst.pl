...
# /usr/bin/scp ${DATA}/nco-5.0.6.tar.gz zender,nco@web.sf.net:/home/project-web/nco/htdocs/src

# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln nco-5.0.6 # Build, do not release on SF
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --sf nco-5.0.6 # Build, release on SF
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --nst_all nco-5.0.6 # Install, do not build
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --nst_all nco-5.0.6 # Build and install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_cnt nco-5.0.6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_prs nco-5.0.6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cgd_cnt nco-5.0.6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cray_prs nco-5.0.6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --bbl_cnt nco-5.0.6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --blk_cnt nco-5.0.6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --dat_cnt nco-5.0.6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --ute_prs nco-5.0.6
...
# Set up FTP server
    ...
    cmd_prc("$tar_cmd cvzf $dst_fl --exclude='nco-5.0.6/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude=ncap_yacc.[ch] ./$dst_vrs"); # Create gzipped tarfile
