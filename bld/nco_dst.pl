...
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln nco-2_1_1 # Build, do not install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --nst_all nco-2_1_1 # Install, do not build
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --nst_all nco-2_1_1 # Build and install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_cnt nco-2_1_1
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_prs nco-2_1_1
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cgd_cnt nco-2_1_1
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cray_prs nco-2_1_1
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --bbl_cnt nco-2_1_1
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --blk_cnt nco-2_1_1
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --dat_cnt nco-2_1_1
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --ute_prs nco-2_1_1
...
my $CVS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.77 2001-12-28 20:09:27 zender Exp $';
...
my $CVS_Date='$Date: 2001-12-28 20:09:27 $';
my $CVS_Id='$Id: nco_dst.pl,v 1.77 2001-12-28 20:09:27 zender Exp $';
my $CVS_Revision='$Revision: 1.77 $';
