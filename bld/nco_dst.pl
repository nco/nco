...
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln nco-2_6_6 # Build, do not install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --nst_all nco-2_6_6 # Install, do not build
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --bld --cln --nst_all nco-2_6_6 # Build and install
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_cnt nco-2_6_6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --acd_prs nco-2_6_6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cgd_cnt nco-2_6_6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --cray_prs nco-2_6_6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --bbl_cnt nco-2_6_6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --blk_cnt nco-2_6_6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --dat_cnt nco-2_6_6
# ${HOME}/nco/bld/nco_dst.pl --dbg=2 --cln --ute_prs nco-2_6_6
...
my $CVS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.93 2002-10-28 07:10:16 zender Exp $';
...
my $CVS_Date='$Date: 2002-10-28 07:10:16 $';
my $CVS_Id='$Id: nco_dst.pl,v 1.93 2002-10-28 07:10:16 zender Exp $';
my $CVS_Revision='$Revision: 1.93 $';
