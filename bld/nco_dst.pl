...
my $CVS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.180 2010-09-24 18:34:34 zender Exp $';
...
my $CVS_Date='$Date: 2010-09-24 18:34:34 $';
my $CVS_Id='$Id: nco_dst.pl,v 1.180 2010-09-24 18:34:34 zender Exp $';
my $CVS_Revision='$Revision: 1.180 $';
...
# Set up FTP server
    chdir $dst_pth_pfx or die "$prg_nm: ERROR unable to chdir to $dst_pth_pfx: $!\n"; # $! is system error string
    cmd_prc("$tar_cmd cvzf $dst_fl --exclude='nco-4.0.4/debian*' --exclude='.cvsignore' --exclude=ncap_lex.c --exclude=ncap_yacc.[ch] ./$dst_vrs"); # Create gzipped tarfile
