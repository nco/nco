...
my $RCS_Header='$Header: /data/zender/nco_20150216/nco/bld/nco_dst.pl,v 1.4 1999-02-26 01:57:20 zender Exp $';
...
my $RCS_Date='$Date: 1999-02-26 01:57:20 $';
my $RCS_Id='$Id: nco_dst.pl,v 1.4 1999-02-26 01:57:20 zender Exp $';
my $RCS_Revision='$Revision: 1.4 $';
