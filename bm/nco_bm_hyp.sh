# $Header: /data/zender/nco_20150216/nco/bm/nco_bm_hyp.sh,v 1.2 2006-05-04 00:47:08 zender Exp $

# Purpose: Perform some NCO benchmarks while hyperslabbing 

# 1
~/nco/bm/cch_clr.pl; /usr/bin/time -a -o ncwa.timing -f "%e wall %s system %U user " \
