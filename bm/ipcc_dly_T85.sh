...
# $Header: /data/zender/nco_20150216/nco/bm/ipcc_dly_T85.sh,v 1.3 2005-03-24 22:17:22 mangalam Exp $
...
echo "This takes ~76.5m on a 2.8GHz Xeon "
echo "This takes ~15m40s on the ESMF - YMMV"
echo ""
echo ""
echo "Starting to populate variables"
echo "ncapping 32 4D vars takes:"
#takes ~8-33m on the ESMF
