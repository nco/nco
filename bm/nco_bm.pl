...
$test[3]='ncks -C -m -s "%f," -v mss_val foo.nc';
...
$test[1]='ncks -C -m -s "%d" -v one_dmn_rec_var foo.nc';
...
$test[1]='ncks -C -m -s "%g" -v rec_var_flt_mss_val_flt foo.nc';
...
$test[3]='ncks -C -m -s "%f, " -v one foo.nc';
...
$test[1]='ncks -C -m -s "%e" -v one foo.nc';
...
$test[3]='ncks -C -m -s "%e" -v two foo.nc';
...
$test[5]='ncks -C -m -s "%g" -v mss_val foo_xymyx.nc';
...
$test[1]='ncks -C -m -s "%4.1f," -v three_dmn_var foo.nc';
...
$test[1]='ncks -C -m -s "%f," -v three_double_dmn foo.nc';
...
$test[1]='ncks -C -m -s "%6.0f" -d time_udunits,"1999-12-08 18:00:0.0","1999-12-09 12:00:0.0",2 -v time_udunits in.nc';
...
$test[1]='ncks -C -m -d wvl,"0.6 micron","1 micron" -s "%3.1e" -v wvl in.nc';
...
$test[2]='ncks -C -m -s "%g" -v upk foo.nc';
...
$test[1]='ncks -C -m -s "%1.5f" -v rec_var_flt_mss_val_dbl foo.nc';
...
$test[5]='ncks -C -m -s "%f" -v rec_var_flt_mss_val_dbl foo.nc';
...
$test[1]='ncks -C -m -s "%e" -v msk_prt_mss_prt foo.nc';
...
$test[1]='ncks -C -m -s "%f," -v three_dmn_var_dbl foo.nc >foo';
...
$test[1]='ncks -C -m -s "%d," -v three_dmn_var_int foo.nc >foo';
...
$test[1]='ncks -C -m -s "%d," -v three_dmn_var_sht foo.nc >foo';
...
$test[1]='ncks -C -m -s "%f" -v three_dmn_rec_var foo.nc';
...
$test[1]='ncks -C -m -s "%f" -v four_dmn_rec_var foo.nc';
...
$test[1]='ncks -C -m -s "%g" -v lat foo.nc';
...
$test[2]='ncks -C -m -s "%e" -v one foo.nc';
...
$test[1]='ncks -C -m -s "%e" -v lon foo.nc';
$test[3]='mv in_tmp.nc in.nc';
