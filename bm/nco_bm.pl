...
# $Header: /data/zender/nco_20150216/nco/bm/nco_bm.pl,v 1.48 2005-07-04 04:45:26 zender Exp $
...
####################
	...
	$tst_cmd[0]="ncwa $omp_flg -h -O -v rec_var_flt_mss_val_dbl in.nc foo_avg.nc";
