// $Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.40 2013-12-31 05:14:02 zender Exp $
...
int main(int argc,char **argv)
{
  ...
  const std::string CVS_Header("$Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.40 2013-12-31 05:14:02 zender Exp $"); // [sng] CVS header string
