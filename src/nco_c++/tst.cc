// $Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.39 2013-10-22 03:12:11 zender Exp $
...
int main(int argc,char **argv)
{
  ...
  const std::string CVS_Header("$Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.39 2013-10-22 03:12:11 zender Exp $"); // [sng] CVS header string
