// $Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.41 2014-06-15 21:06:25 zender Exp $
...
int main(int argc,char **argv)
{
  ...
  const std::string CVS_Header("$Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.41 2014-06-15 21:06:25 zender Exp $"); // [sng] CVS header string
