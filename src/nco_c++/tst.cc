// $Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.32 2009-04-19 23:17:04 zender Exp $
...
int main(int argc,char **argv)
{
  ...
  const std::string CVS_Date("$Date: 2009-04-19 23:17:04 $"); // [sng] CVS date string
  const std::string CVS_Header("$Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.32 2009-04-19 23:17:04 zender Exp $"); // [sng] CVS header string
  const std::string CVS_Id("$Id: tst.cc,v 1.32 2009-04-19 23:17:04 zender Exp $"); // [sng] CVS identification string
  const std::string CVS_Revision("$Revision: 1.32 $"); // [sng] CVS revision string
