// $Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.5 2002-08-21 18:58:44 rorik Exp $
...
int main(int argc,char **argv)
{
  ...
  const std::string CVS_Date("$Date: 2002-08-21 18:58:44 $"); // [sng] CVS date string
  const std::string CVS_Header("$Header: /data/zender/nco_20150216/nco/src/nco_c++/tst.cc,v 1.5 2002-08-21 18:58:44 rorik Exp $"); // [sng] CVS header string
  const std::string CVS_Id("$Id: tst.cc,v 1.5 2002-08-21 18:58:44 rorik Exp $"); // [sng] CVS identification string
  const std::string CVS_Revision("$Revision: 1.5 $"); // [sng] CVS revision string
...
#define TKN2SNG(x) XTKN2SNG(x)
  ...
  const int *dmn_scl(NULL); // [dmn] Dummy argument, not used
