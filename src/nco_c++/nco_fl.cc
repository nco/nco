// $Header: /data/zender/nco_20150216/nco/src/nco_c++/nco_fl.cc,v 1.1 2002-01-11 23:20:29 zender Exp $ 

// Implementation (declaration) of C++ interface to netCDF file-level routines
