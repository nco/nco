...
# endif /* !GCC < 4.9 */
	...
	if(trv.flg_rgr){
	  ...
	  if(has_lev) mrv_nbr_in*=lev_nbr_in; else mrv_nbr_in*=ilev_nbr_in;
	  if(has_lev) mrv_nbr_out*=lev_nbr_out; else mrv_nbr_out*=ilev_nbr_out;
