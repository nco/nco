/* $Header: /data/zender/nco_20150216/nco/src/nco/ncap.c,v 1.213 2007-06-29 15:00:42 zender Exp $ */
...
#define NCAP_SPT_NBR_MAX 100
  ...
  const char * const CVS_Id="$Id: ncap.c,v 1.213 2007-06-29 15:00:42 zender Exp $"; 
