/* $Header: /data/zender/nco_20150216/nco/src/nco/ncap.c,v 1.272 2013-08-01 05:44:02 zender Exp $ */
...
#define NCAP_SPT_NBR_MAX 100
  ...
  const char * const CVS_Id="$Id: ncap.c,v 1.272 2013-08-01 05:44:02 zender Exp $"; 
