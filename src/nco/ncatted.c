/* $Header: /data/zender/nco_20150216/nco/src/nco/ncatted.c,v 1.1.1.1 1998-08-18 05:35:00 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  char *time_buf_srt;
  char *cmd_ln;
  char rcs_Id[]="$Id: ncatted.c,v 1.1.1.1 1998-08-18 05:35:00 zender Exp $"; 
