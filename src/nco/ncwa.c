/* $Header: /data/zender/nco_20150216/nco/src/nco/ncwa.c,v 1.1.1.1 1998-08-18 05:35:00 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  char *wgt_nm=NULL;
  char *cmd_ln;
  char rcs_Id[]="$Id: ncwa.c,v 1.1.1.1 1998-08-18 05:35:00 zender Exp $"; 
