/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_mss_val.c,v 1.36 2008-01-06 13:09:53 zender Exp $ */
 ...
 var_sct * const var) /* I/O [sct] Variable with missing_value to update */
{
  ...
  for(idx=0;idx<var->nbr_att;idx++){
    ...
    if(WRN_FIRST && !(int)strcasecmp(att_nm,"missing_value")) has_fll_val=True;
    if((int)strcasecmp(att_nm,"_FillValue")) continue;
