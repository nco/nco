/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_fl_utl.c,v 1.105 2008-08-30 00:17:50 zender Exp $ */
...
/* #endif HAVE_RES_ */
    ...
    if(rmt_cmd == NULL){
      (void)fprintf(stderr,"%s: ERROR %s neither exists locally nor resembles remote filename patterns\n",prg_nm_get(),fl_nm_rmt);
      nco_exit(EXIT_FAILURE);
    } /* end if */
