/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_var_lst.c,v 1.48 2005-08-03 01:04:51 zender Exp $ */
 ...
 int * const nbr_var_prc) /* O [nbr] Number of processed variables */
{
  ...
  for(idx=0;idx<nbr_var;idx++){
    ...
    if(NCAR_CCSM_FORMAT){
      ...
      if(prg == ncbo && (!strcmp(var_nm,"hyam") || !strcmp(var_nm,"hybm") || !strcmp(var_nm,"hyai") || !strcmp(var_nm,"hybi") || !strcmp(var_nm,"gw") || !strcmp(var_nm,"lon_bnds") || !strcmp(var_nm,"lat_bnds") || !strcmp(var_nm,"area") || !strcmp(var_nm,"ORO") || !strcmp(var_nm,"date") || !strcmp(var_nm,"datesec"))) var_op_typ[idx]=fix;
