/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_lmt.c,v 1.37 2005-05-23 00:12:53 zender Exp $ */
...
(lmt_all_sct *lmt_all) /* I/O [sct] Limit structure to free */
{
  ...
  lmt_all->lmt_dmn[0]=(lmt_sct *)nco_free(lmt_all->lmt_dmn[0]);
