/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.263 2010-06-08 19:07:10 zender Exp $ */
...
{ 
  ...
  return "Potsdam: Read \"Adrift: Seventy Six Days Lost at Sea\", by Steven Callahan\n";
} /* end nco_nmn_get() */
