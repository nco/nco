/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.60 2004-08-07 21:16:03 zender Exp $ */
...
nco_usg_prn(void)
{
  ...
  if(strstr(opt_sng,"-a")){
    ...
    if(prg_lcl == ncpdq) (void)fprintf(stdout,"-a, --arrange, --permute, --reorder, --rdr rdr_dim1[,rdr_dim2[...]] Re-ordering dimensions\n");
