/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.248 2009-07-16 02:30:05 zender Exp $ */
...
{ 
  ...
  return "Consumermania: Samsung tones, Google Phones, Motorola bones.\n";
} /* end nco_nmn_get() */
