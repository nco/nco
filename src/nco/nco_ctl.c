...
nco_usg_prn(void)
{
  ...
  if(strstr(opt_sng,"--rnr")) (void)fprintf(stdout,"    --rnr, --renormalize\t\tRenormalize destination values by valid area\n");
