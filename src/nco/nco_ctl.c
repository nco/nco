/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.485 2014-07-07 06:07:44 zender Exp $ */
...
{ 
  ...
  return "Re-discover the Mix. Listen to Club Wynn.\n";
} /* end nco_nmn_get() */
