/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.261 2010-04-19 19:30:53 zender Exp $ */
...
{ 
  ...
  return "Saw Ghost Town (hilarious), reading Percy Jackson Book II: The Sea of Monsters\n";
} /* end nco_nmn_get() */
