/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.247 2009-06-17 03:47:34 zender Exp $ */
...
{ 
  ...
  return "Listen to Evolver, by John Legend. Watch I Love You, Man, with Paul Rudd. Read Bridge of Sighs, by Richard Russo.\n";
} /* end nco_nmn_get() */
