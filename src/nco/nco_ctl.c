/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.74 2004-09-07 19:50:14 zender Exp $ */
...
nco_usg_prn(void)
{
  ...
  case ncks:
    ...
    break;
  case ncpdq:
    opt_sng=(char *)strdup("[-A] [-a ...] [-C] [-c] [-D dbg_lvl] [-d ...] [-F] [-h] [-l path] [-M pck_map][-O] [-o out.nc] [-P pck_plc] [-p path] [-R] [-r] [-t] [-v ...] [-U] [-x] in.nc [out.nc]\n");
    break;
  case ncra:
  case ncea:
  ...
  if(strstr(opt_sng,"-M")){
    ...
    if(prg_lcl == ncpdq) (void)fprintf(stdout,"-M, --pck_map, --map pck_map\tPack map [dwn_one,flt_byt,flt_sht,hgh_byt,hgh_sht]\n");
  } /* end if */
  if(strstr(opt_sng,"-m")){
