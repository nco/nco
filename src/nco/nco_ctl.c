/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.399 2013-07-20 02:21:20 zender Exp $ */
...
nco_usg_prn(void)
{
  ...
  if(strstr(opt_sng,"--xml")) (void)fprintf(stdout,"    --xml\t\tPrint XML (NcML)\n");
