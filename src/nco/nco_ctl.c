/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.384 2013-03-28 00:46:07 zender Exp $ */
...
nco_usg_prn(void)
{
  ...
  case ncatted:
    ...
    break;
  case ncbo:
    opt_sng=(char *)strdup("[-3] [-4] [-6] [-A] [--bfr sz] [-C] [-c] [--cnk_dmn nm,sz] [--cnk_map map] [--cnk_plc plc] [--cnk_scl sz] [-D dbg_lvl] [-d ...] [-F] [-g ...] [-h] [--hdr_pad nbr] [-L lvl] [-l path] [-n ...] [--no_tmp_fl] [-O] [-o out.nc] [-p path] [-R] [-r] [--ram_all] [-t thr_nbr] [-v ...] [-X box] [-x] [-y op_typ] in_1.nc in_2.nc [out.nc]\n");
    break;
  case ncflint:
