/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.235 2009-03-27 21:55:14 zender Exp $ */
...
{ 
  ...
  return "Throttle threading. The Worst Hard Time, by Timothy Egan\n";
} /* end nco_nmn_get() */
