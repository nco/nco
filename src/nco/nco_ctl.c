/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_ctl.c,v 1.262 2010-05-20 21:13:57 zender Exp $ */
...
{ 
  ...
  return "Saw Ghost Town (hilarious), reading Percy Jackson Book III: The Titan's Curse\n";
} /* end nco_nmn_get() */
