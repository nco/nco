/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_grp_trv.c,v 1.279 2014-02-28 03:48:02 pvicente Exp $ */
...
(trv_tbl_sct *tbl)                     /* I [sct] Traversal table */
{
  ...
  for(int idx_nsm=0;idx_nsm<tbl->nsm_nbr;idx_nsm++){
    ...
    for(int idx=0;idx<tbl->nsm[idx_nsm].skp_nbr;idx++){
      tbl->nsm[idx_nsm].skp_nm[idx]=(char *)nco_free(tbl->nsm[idx_nsm].skp_nm[idx]);
    }
#endif
