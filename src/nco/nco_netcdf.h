/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_netcdf.h,v 1.56 2009-05-03 07:54:43 zender Exp $ */
...
int nco_def_var_chunking(const int nc_id,const int var_id,const int str_typ,size_t * const cnk_sz);
