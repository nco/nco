/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_netcdf.h,v 1.81 2012-04-04 04:30:51 zender Exp $ */
...
int nco__open(const char * const fl_nm,const int mode,size_t bfr_sz_hnt,int * const nc_id);
