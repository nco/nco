/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_netcdf.h,v 1.95 2013-03-13 22:49:40 pvicente Exp $ */
...
int nco_inq_dimid2(int ncid,const char *dmn_nm_fll,int *dmn_id);
