/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_netcdf.h,v 1.77 2011-07-26 06:45:55 zender Exp $ */
...
int nco_inq_grpname_full(const int nc_id,size_t * nm_lng,char * const grp_nm_fll);
