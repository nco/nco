/* $Header: /data/zender/nco_20150216/nco/src/nco/mpncecat.c,v 1.89 2011-04-26 22:56:28 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: mpncecat.c,v 1.89 2011-04-26 22:56:28 zender Exp $"; 
