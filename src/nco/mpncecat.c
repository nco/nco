/* $Header: /data/zender/nco_20150216/nco/src/nco/mpncecat.c,v 1.93 2012-03-12 06:29:18 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: mpncecat.c,v 1.93 2012-03-12 06:29:18 zender Exp $"; 
