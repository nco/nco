/* $Header: /data/zender/nco_20150216/nco/src/nco/mpncbo.c,v 1.77 2008-01-15 22:20:49 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: mpncbo.c,v 1.77 2008-01-15 22:20:49 zender Exp $"; 
  const char * const CVS_Revision="$Revision: 1.77 $";
  const char * const opt_sht_lst="4ACcD:d:FhL:l:Oo:p:rRSt:v:xy:-:";
