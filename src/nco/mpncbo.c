/* $Header: /data/zender/nco_20150216/nco/src/nco/mpncbo.c,v 1.75 2007-12-12 16:33:54 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: mpncbo.c,v 1.75 2007-12-12 16:33:54 zender Exp $"; 
