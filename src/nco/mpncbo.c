/* $Header: /data/zender/nco_20150216/nco/src/nco/mpncbo.c,v 1.114 2012-03-12 06:29:18 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: mpncbo.c,v 1.114 2012-03-12 06:29:18 zender Exp $"; 
