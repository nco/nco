/* $Header: /data/zender/nco_20150216/nco/src/nco/mpncbo.c,v 1.60 2006-10-20 00:13:01 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: mpncbo.c,v 1.60 2006-10-20 00:13:01 zender Exp $"; 
