/* $Header: /data/zender/nco_20150216/nco/src/nco/ncbo.c,v 1.119 2008-02-22 14:26:34 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncbo.c,v 1.119 2008-02-22 14:26:34 zender Exp $"; 
...
#pragma omp parallel for default(none) firstprivate(ddra_info) private(idx,in_id_1,in_id_2) shared(dbg_lvl,dim_1,fl_in_1,fl_in_2,fl_out,flg_ddra,in_id_1_arr,in_id_2_arr,nbr_dmn_xtr_1,nbr_var_prc_1,nbr_var_prc_2,nco_op_typ,out_id,prg_nm,rcd,var_prc_1,var_prc_2,var_prc_out)
#endif /* !_OPENMP */
