/* $Header: /data/zender/nco_20150216/nco/src/nco/ncbo.c,v 1.228 2013-03-23 14:29:52 pvicente Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncbo.c,v 1.228 2013-03-23 14:29:52 pvicente Exp $"; 
  ...
  (void)trv_tbl_mch(in_id_1,in_id_2,out_id,cnk_map,cnk_plc,cnk_sz_scl,cnk,cnk_nbr,dfl_lvl,False,CNV_CCM_CCSM_CF,(dmn_sct **)NULL,0,trv_tbl_1,trv_tbl_2,True);
#else /* USE_TRV_API */
  ...
  (void)trv_tbl_mch(in_id_1,in_id_2,out_id,cnk_map,cnk_plc,cnk_sz_scl,cnk,cnk_nbr,dfl_lvl,False,CNV_CCM_CCSM_CF,(dmn_sct **)NULL,0,trv_tbl_1,trv_tbl_2,False);
#else /* USE_TRV_API */
