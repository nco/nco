%{ /* $Header: /data/zender/nco_20150216/nco/src/nco/ncap_yacc.y,v 1.19 2004-07-23 12:47:24 hmb Exp $ -*-C-*- */
...
#define YY_DECL int yylex(YYSTYPE *lval_ptr,prs_sct *prs_arg) YY_DECL;
