/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_fortran.h,v 1.1 2002-05-05 19:52:36 zender Exp $ */
...
extern "C" {
  ...
  void FORTRAN_divide_double_precision(long *,int *,double *,double *,double *);
  void FORTRAN_divide_real(long *,int *,float *,float *,float *);
  void FORTRAN_multiply_double_precision(long *,int *,double *,double *,double *);
  void FORTRAN_multiply_real(long *,int *,float *,float *,float *);
