/* $Header: /data/zender/nco_20150216/nco/src/nco/ncrename.c,v 1.96 2006-10-20 00:13:01 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncrename.c,v 1.96 2006-10-20 00:13:01 zender Exp $"; 
