/* $Header: /data/zender/nco_20150216/nco/src/nco/ncrename.c,v 1.25 2000-10-20 23:16:43 zender Exp $ */
...
/*  int cbreak(void);*/
  ...
  char *time_bfr_srt;
  char *cmd_ln;
  char CVS_Id[]="$Id: ncrename.c,v 1.25 2000-10-20 23:16:43 zender Exp $"; 
