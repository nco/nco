/* $Header: /data/zender/nco_20150216/nco/src/nco/ncflint.c,v 1.8 1999-05-12 03:06:48 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  char rcs_Id[]="$Id: ncflint.c,v 1.8 1999-05-12 03:06:48 zender Exp $"; 
