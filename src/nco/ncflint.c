/* $Header: /data/zender/nco_20150216/nco/src/nco/ncflint.c,v 1.2 1998-08-19 04:27:27 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  char rcs_Id[]="$Id: ncflint.c,v 1.2 1998-08-19 04:27:27 zender Exp $"; 
