/* $Header: /data/zender/nco_20150216/nco/src/nco/ncflint.c,v 1.120 2006-05-19 20:25:53 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncflint.c,v 1.120 2006-05-19 20:25:53 zender Exp $"; 
  ...
  if(EXTRACT_ALL_COORDINATES) xtr_lst=nco_var_lst_add_crd(in_id_1,nbr_dmn_fl,xtr_lst,&nbr_xtr);
