/* $Header: /data/zender/nco_20150216/nco/src/nco/ncflint.c,v 1.194 2012-03-12 06:29:18 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncflint.c,v 1.194 2012-03-12 06:29:18 zender Exp $"; 
