/* $Header: /data/zender/nco_20150216/nco/src/nco/ncks.c,v 1.490 2012-11-30 01:32:29 pvicente Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncks.c,v 1.490 2012-11-30 01:32:29 pvicente Exp $"; 
