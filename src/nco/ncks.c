/* $Header: /data/zender/nco_20150216/nco/src/nco/ncks.c,v 1.400 2012-10-13 01:05:00 pvicente Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncks.c,v 1.400 2012-10-13 01:05:00 pvicente Exp $"; 
  ...
  (void)nco4_inq_trv(in_id,&nbr_dmn_fl,&nbr_var_fl,&nbr_grp_fl,trv_tbl);
