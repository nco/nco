/* $Header: /data/zender/nco_20150216/nco/src/nco/ncks.c,v 1.597 2013-02-23 04:32:13 pvicente Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncks.c,v 1.597 2013-02-23 04:32:13 pvicente Exp $"; 
  const char * const CVS_Revision="$Revision: 1.597 $";
  ...
  if(fl_out){
    ...
    (void)nco_xtr_dfn(in_id,out_id,&cnk_map,&cnk_plc,cnk_sz_scl,cnk,cnk_nbr,dfl_lvl,gpe,PRN_GLB_METADATA,PRN_VAR_METADATA,rec_dmn_nm,trv_tbl);
