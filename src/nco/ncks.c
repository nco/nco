/* $Header: /data/zender/nco_20150216/nco/src/nco/ncks.c,v 1.693 2014-01-02 22:56:39 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncks.c,v 1.693 2014-01-02 22:56:39 zender Exp $"; 
  const char * const CVS_Revision="$Revision: 1.693 $";
  ...
  if(fl_out){
    ...
    (void)nco_xtr_dfn(in_id,out_id,&cnk_map,&cnk_plc,cnk_sz_scl,cnk_dmn,cnk_nbr,dfl_lvl,gpe,md5,PRN_GLB_METADATA,PRN_VAR_METADATA,nco_pck_plc_nil,rec_dmn_nm,trv_tbl);
