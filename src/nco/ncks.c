/* $Header: /data/zender/nco_20150216/nco/src/nco/ncks.c,v 1.352 2012-09-11 19:35:39 pvicente Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncks.c,v 1.352 2012-09-11 19:35:39 pvicente Exp $"; 
