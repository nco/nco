/* $Header: /data/zender/nco_20150216/nco/src/nco/ncdiff.c,v 1.31 2000-09-05 20:40:09 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  char *time_bfr_srt;
  char *cmd_ln;
  char CVS_Id[]="$Id: ncdiff.c,v 1.31 2000-09-05 20:40:09 zender Exp $"; 
