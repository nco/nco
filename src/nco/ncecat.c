/* $Header: /data/zender/nco_20150216/nco/src/nco/ncecat.c,v 1.257 2013-02-09 01:29:47 zender Exp $ */
...
#define	NCO_GRP_OUT_SFX_LNG 2
  ...
  const char * const CVS_Id="$Id: ncecat.c,v 1.257 2013-02-09 01:29:47 zender Exp $"; 
