...
# define NCO_VERSION_NOTE "-beta05" /* Blank for final versions, non-blank (e.g., "-beta37") for pre-release versions */
...
#ifndef NCO_VERSION
# define NCO_VERSION "5.1.0-beta05"
#endif /* !NCO_VERSION */
...
#define TRV_MAP_SIZE NC_MAX_DIMS
  ...
  enum nco_baa_cnv{ /* [enm] Bit-Adjustment Algorithm to use */
    nco_baa_bgr, /* 0 BitGroom (option since 201502XX, default 201502XX--20200717) */
