/* $Header: /data/zender/nco_20150216/nco/src/nco/nco_netcdf.c,v 1.170 2012-12-18 21:07:03 pvicente Exp $ */
...
int nco_inq_grpname(const int nc_id,char * const grp_nm){assert(0);return NC_NOERR;}
