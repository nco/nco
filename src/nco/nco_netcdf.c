...
(const int fl_fmt) /* I [enm] netCDF file format */
{
  ...
  case NC_FORMAT_CDF5:
    return "cdf5 = NC_FORMAT_CDF5 = CDF5 = PnetCDF = PIO. This is the most modern and capacious flavor of Unidata's Classic Data Model, https://docs.unidata.ucar.edu/netcdf-c/current/netcdf_data_model.html. Chunking and compression are not supported. This format has no variable size limitations of real-world import.";
  default: nco_dfl_case_nc_type_err(); break;
  } /* !fl_fmt */
