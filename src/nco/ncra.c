/* $Header: /data/zender/nco_20150216/nco/src/nco/ncra.c,v 1.215 2008-01-16 12:41:07 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncra.c,v 1.215 2008-01-16 12:41:07 zender Exp $"; 
...
#ifdef _OPENMP
#pragma omp parallel for default(none) private(idx,in_id) shared(dbg_lvl,fl_idx,in_id_arr,lmt_rec,nbr_var_prc,nco_op_typ,rcd,var_prc,var_prc_out)
#endif /* !_OPENMP */
