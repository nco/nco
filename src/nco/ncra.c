/* $Header: /data/zender/nco_20150216/nco/src/nco/ncra.c,v 1.190 2006-10-20 00:13:01 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncra.c,v 1.190 2006-10-20 00:13:01 zender Exp $"; 
