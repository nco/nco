/* $Header: /data/zender/nco_20150216/nco/src/nco/ncra.c,v 1.375 2013-09-11 02:07:28 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncra.c,v 1.375 2013-09-11 02:07:28 zender Exp $"; 
...
#pragma omp parallel for default(none) private(idx) shared(nbr_var_prc,nco_op_typ,var_prc,var_prc_out)
  ...
  if(prg == ncra || prg == ncrcat){
    /* Build records to process  */
    (void)nco_bld_rec(trv_tbl);
  }
