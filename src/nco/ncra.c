/* $Header: /data/zender/nco_20150216/nco/src/nco/ncra.c,v 1.285 2012-06-23 04:32:56 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncra.c,v 1.285 2012-06-23 04:32:56 zender Exp $"; 
