/* $Header: /data/zender/nco_20150216/nco/src/nco/ncra.c,v 1.240 2009-06-11 17:28:32 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncra.c,v 1.240 2009-06-11 17:28:32 zender Exp $"; 
  ...
  if(rec_dmn_id == NCO_REC_DMN_UNDEFINED){
    ...
    if(prg == ncra || prg == ncrcat){
      ...
      if(rcd == NC_NOERR) lmt_rec->re_bs_sng=nco_lmt_get_udu_att(in_id,var_id); else lmt_rec->re_bs_sng=(char *)NULL;
    } /* endif ncra, ncrcat */
