/* $Header: /data/zender/nco_20150216/nco/src/nco/ncra.c,v 1.402 2013-09-20 20:47:45 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncra.c,v 1.402 2013-09-20 20:47:45 zender Exp $"; 
