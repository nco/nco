/* $Header: /data/zender/nco_20150216/nco/src/nco/ncpdq.c,v 1.129 2008-01-15 22:20:50 zender Exp $ */
...
main(int argc,char **argv)
{
  ...
  const char * const CVS_Id="$Id: ncpdq.c,v 1.129 2008-01-15 22:20:50 zender Exp $"; 
