...
void ncoLexer::mSTR_ATT_QT(bool _createToken) {
	...
	match('@' /* charlit */ );
	mVAR_NM_QT(false);
#line 591 "ncoGrammer.g"
	_ttype = STR_ATT_QT;
#line 2425 "ncoLexer.cpp"
	{
	_saveIndex = text.length();
	match('\'' /* charlit */ );
	text.erase(_saveIndex);
