...
#line 2439 "ncoTree.cpp"
					...
					if ( synPredMatched253 ) {
						...
						_t = _t->getNextSibling();
						if ( inputState->guessing==0 ) {
#line 1530 "ncoGrammer.g"
							
							;
							
#line 2484 "ncoTree.cpp"
						}
					}
...
#line 2826 "ncoGrammer.g"
	var_sct *var;
#line 3801 "ncoTree.cpp"
