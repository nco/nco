...
#line 1771 "ncoTree.cpp"
		...
		default:
			...
			if ( synPredMatched277 ) {
				...
				_t = _t->getNextSibling();
				if ( inputState->guessing==0 ) {
#line 1877 "ncoGrammer.g"
					var=ncap_var_var_op(var1,var2, PLUS );
#line 1817 "ncoTree.cpp"
				}
			}
			else {
