/* $ANTLR 2.7.7 (20111217): "ncoGrammer.g" -> "ncoTree.cpp"$ */
#include "ncoTree.hpp"
...
#line 3429 "ncoTree.cpp"
	
	try {      // for error handling
		if ( inputState->guessing==0 ) {
#line 2548 "ncoGrammer.g"
