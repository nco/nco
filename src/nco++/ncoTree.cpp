...
#line 1075 "ncoTree.cpp"
	...
	try {      // for error handling
		...
		case TIMES:
		{
			...
			_t = _t->getNextSibling();
			if ( inputState->guessing==0 ) {
#line 1331 "ncoGrammer.g"
				var=ncap_var_var_op(var1,var2, TIMES );
#line 1096 "ncoTree.cpp"
			}
			break;
		}
		case DIVIDE:
