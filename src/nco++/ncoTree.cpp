...
#line 2230 "ncoTree.cpp"
					...
					_t = _t->getNextSibling();
					if ( inputState->guessing==0 ) {
#line 1285 "ncoGrammer.g"
						var=ncap_var_var_op(var1,(var_sct*)NULL, MINUS );
#line 2245 "ncoTree.cpp"
					}
				}
