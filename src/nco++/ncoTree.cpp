...
#line 1463 "ncoTree.cpp"
		...
		case VALUE_LIST:
		{
			...
			_t = _t->getNextSibling();
			if ( inputState->guessing==0 ) {
#line 2090 "ncoGrammer.g"
				
				var=value_list(vlst);
				
#line 1477 "ncoTree.cpp"
			}
			break;
		}
		case NSTRING:
